...
上位PCとの通信方式は USB-Serial をデフォルトとしていますが、その他の通信方式も選択することができます。対応している通信の詳細は[cugo_v4.5_ros2_controlのreadme](https://github.com/CuboRex-Development/cugo_v4.5_ros2_control) の Usage をご参照ください。
設定は `config.h` の 1行を変更するだけで切り替えられます。
...
接続の詳細は[cugo_v4.5_ros2_controlのreadme](https://github.com/CuboRex-Development/cugo_v4.5_ros2_control) の Usage をご参照ください。
